...
Four independent [Bridgetown](https://www.bridgetownrb.com) static sites, each
...
```bash
make            # list targets
make dev        # foreman: run all four sites at once, on derived ports
...
- **Sites/services:** four, indices 0–3 — see `Projects/services.md`. Indices
