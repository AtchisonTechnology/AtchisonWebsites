...
| `/service-ownership-diagnostic/` | Lead magnet | A real page replacing Kit's hosted landing page of the same path, with the same Kit form (uid `2e2d7fc0c1`) embedded. Copy and structure carried over from the Kit page. (Decided 2026-09-03, Open Question 11.) |
| `/architecting-with-ai/` | Webinar page | A real page replacing Kit's hosted landing page, same Kit form (uid `4cad4660e5`) embedded. **Kept regardless of the webinar date** — Lee: it is the gate through which people get the slides and recording afterwards, so the copy is written to work both before and after the event. (Decided 2026-09-03, Open Question 11.) |
...
| `/architecting-with-ai` | Kit hosted landing page (webinar registration, form uid `4cad4660e5`, named UTM campaign `architecting-systems-with-ai-webinar`) | **Served** by a real page at the same path (Part 4). Kept permanently as the gate for the slides and recording (decided 2026-09-03). |
| `/service-ownership-diagnostic` | Kit hosted landing page (lead magnet, form uid `2e2d7fc0c1`) | **Served** by a real page at the same path (Part 4). A standing lead magnet and a pre-registered gate metric for the `service-ownership` course (decided 2026-09-03). |
